...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col justify-end items-center pb-2" style={{ zIndex: 3 }}>

        {/* Card ultra compacto - 75% ancho, EN LA PARTE INFERIOR */}
        <div 
          ...
          style={{ 
            ...
            boxShadow: '0 10px 35px rgba(0,0,0,0.25), 0 0 0 1px rgba(255,255,255,0.2)',
          ...
          <div className="px-2.5 py-2">
            ...
            <div className="space-y-1 mb-1.5">
              ...
              <button
                ...
                style={{
                  ...
                  color: tipoJuego === 90 ? '#FFFFFF' : '#2D2D2D',
                  boxShadow: tipoJuego === 90
                    ? '0 5px 18px rgba(196,30,58,0.4), 0 0 0 1px rgba(255,255,255,0.3), inset 0 1px 0 rgba(255,255,255,0.25)'
                    : '0 2px 10px rgba(0,0,0,0.12), 0 0 0 1px rgba(255,255,255,0.3), inset 0 1px 0 rgba(255,255,255,0.4)',
                  border: '1px solid rgba(255, 255, 255, 0.2)',
                  textShadow: tipoJuego === 90 ? '0 1px 3px rgba(0,0,0,0.4)' : '0 1px 2px rgba(0,0,0,0.2)',
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  backdropFilter: 'blur(10px) saturate(160%)',
                  WebkitBackdropFilter: 'blur(10px) saturate(160%)',
                  color: tipoJuego === 75 ? '#FFFFFF' : '#2D2D2D',
                  boxShadow: tipoJuego === 75
                    ? '0 5px 18px rgba(0,102,204,0.4), 0 0 0 1px rgba(255,255,255,0.3), inset 0 1px 0 rgba(255,255,255,0.25)'
                    : '0 2px 10px rgba(0,0,0,0.12), 0 0 0 1px rgba(255,255,255,0.3), inset 0 1px 0 rgba(255,255,255,0.4)',
                  border: '1px solid rgba(255, 255, 255, 0.2)',
                  textShadow: tipoJuego === 75 ? '0 1px 3px rgba(0,0,0,0.4)' : '0 1px 2px rgba(0,0,0,0.2)',
                }}
              >
                <div className="flex items-center justify-center gap-1.5">
                  <span className="text-sm">🎲</span>
              ...
              <button
                ...
                style={{
                  ...
                  backdropFilter: 'blur(10px) saturate(160%)',
                  WebkitBackdropFilter: 'blur(10px) saturate(160%)',
                  color: tipoJuego === 'custom' ? '#1a1a2e' : '#2D2D2D',
                  boxShadow: tipoJuego === 'custom'
                    ? '0 5px 18px rgba(255,193,7,0.4), 0 0 0 1px rgba(255,255,255,0.3), inset 0 1px 0 rgba(255,255,255,0.3)'
                    : '0 2px 10px rgba(0,0,0,0.12), 0 0 0 1px rgba(255,255,255,0.3), inset 0 1px 0 rgba(255,255,255,0.4)',
                  border: '1px solid rgba(255, 255, 255, 0.2)',
                  textShadow: tipoJuego === 'custom' ? '0 1px 3px rgba(0,0,0,0.3)' : '0 1px 2px rgba(0,0,0,0.2)',
                }}
              >
                <div className="flex items-center justify-center gap-1.5">
            ...
            <button
              ...
              style={{
                ...
                color: 'white',
                boxShadow: '0 6px 20px rgba(0,155,58,0.5), 0 0 0 1px rgba(255,255,255,0.25), inset 0 1px 0 rgba(255,255,255,0.3)',
            ...
            <div className="grid grid-cols-2 gap-1">
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 2px 5px rgba(196,30,58,0.12), inset 0 1px 0 rgba(255,255,255,0.3)',
                }}
              >
                ⚙️ Configuración
              </button>
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 2px 5px rgba(0,102,204,0.12), inset 0 1px 0 rgba(255,255,255,0.3)',
                }}
              >
                🎫 Cartones
              </button>
        ...
        {/* Logo ultra pequeño - debajo del card */}
