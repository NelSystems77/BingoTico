...
function calculateTotalChars() {
  ...
  console.log(`Sobrante estimado sobre 10,000: ${10000 - total - varTotal}\n`);
}
...
async function main() {
  ...
  console.log('═══════════════════════════════════════════════════════════');
  console.log('FASE 1: Generando números base del 1 al 75 (voz: Jessica)');
  console.log('═══════════════════════════════════════════════════════════\n');
  ...
  console.log('═══════════════════════════════════════════════════════════════');
  console.log('FASE 2: Generando variaciones para números especiales (Jessica)');
  console.log('═══════════════════════════════════════════════════════════════');
  ...
  console.log('═══════════════════════════════════════');
  console.log(`Voz utilizada:           Jessica (cgSgspJ2msm6clMCkdW9)`);
