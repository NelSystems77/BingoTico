/**
 * Script para generar variaciones de audio para números 1-75 (voz femenina)
 * Voz: cgSgspJ2msm6clMCkdW9 - Jessica (Playful, Bright, Warm)
...
async function main() {
  ...
  console.log('GENERADOR DE VARIACIONES - VOZ FEMENINA (Jessica)');
  ...
  console.log('\nArchivos _var.mp3 en numbers-female/: ' + varFiles.length);
  console.log('Total archivos MP3 en numbers-female/: ' + allFiles.length);
  console.log('═'.repeat(60) + '\n');
}
