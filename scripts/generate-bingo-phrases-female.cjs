 ...
 * Genera/reemplaza los archivos N_var.mp3 en public/audio/numbers-female/
 * Total: 90 frases = 2,391 caracteres (cuota disponible: ~2,456)
...
async function main() {
  ...
  console.log('GENERADOR DE FRASES DE BINGO COSTARRICENSE - VOZ FEMENINA');
  console.log('Voz: Jessica (cgSgspJ2msm6clMCkdW9) - Playful, Bright, Warm');
  console.log('Destino: public/audio/numbers-female/N_var.mp3');
  console.log('='.repeat(65));
  ...
  if (failed.length > 0) console.log('Números fallidos:      ' + failed.join(', '));
  ...
  console.log('\nArchivos _var.mp3 en numbers-female/: ' + allFiles.length);
  console.log('='.repeat(65) + '\n');
